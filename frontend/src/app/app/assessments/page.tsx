  ...
  return (
    <div className="mx-auto max-w-4xl">
      ...
      <p className="mt-2 text-sm text-[var(--muted)]">
        {isStudent
          ? "Take Normal CBT tests assigned to your class, or open JAMB practice when available."
          : "Create Normal CBT papers that write into CA1, CA2, or Exam scores. JAMB CBT is a separate practice module."}
      </p>
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2">
        ...
        >
          ...
          <p className="mt-2 text-sm text-[var(--muted)]">
            UTME-style practice with progress tracking. Does not update school
            report scores.
          </p>
        </Link>
      </div>
